                ...
                <div>
                  <div class="mt-3">
                    ...
                    <img 
                        ...
                        :alt="'Imagen de ' + bebidas.receta.strDrinkThumb"
                        class="mx-auto w-96 rounded-lg"
                    />
...
<!-- <table class="table-auto my-8" >
  ...
  <tbody>
    <tr>
      <td>Prueba 1 de acuerdo a las cantidades que van aqui</td>
      <td>20 Kg</td>
    </tr>   
  </tbody>
</table> -->
                ...
                <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                    <button 
                        type="button" 
                        class="w-full rounded-xl bg-gray-600 p-3 font-bold uppercase text-white shadow hover:bg-gray-500   "
                        @click="modal.handleClickModal()"
                    >Cerrar
                    </button> 
                    <button 
                        type="button" 
                        class="w-full rounded-xl bg-orange-300 p-3 font-bold uppercase text-white shadow hover:bg-orange-500   "
